...
class Program
{
    ...
    static void AddBook()
    {
        ...
        if (existingBook != null)
        {
            ...
            ShowMessage("Kitap bulundu. Stok artırıldı.", ConsoleColor.Green);
        }
        else
        {
            books.Add(new Book { Title = title, Author = author, Year = year, Stock = stock });
            ShowMessage("Kitap başarıyla eklendi.", ConsoleColor.Green);
        }
    }
